    ...
    class HTTP
    {
        public static function webRequest( $HTTPVerb, $url, array $urlParams = array() ) {
            switch( strtoupper( $HTTPVerb ) ) {
                case HTTPVerbs::HEAD:
                    return HTTP::httpHEAD( NULL, $url, $urlParams );
                case HTTPVerbs::GET;
                    return HTTP::httpGET( NULL, $url, $urlParams );
                case HTTPVerbs::POST:
                    return HTTP::httpPOST( NULL, $url, $urlParams );
                case HTTPVerbs::PATCH:
                    return HTTP::httpPATCH( NULL, $url, $urlParams );
                case HTTPVerbs::PUT:
                    return HTTP::httpPUT( NULL, $url, $urlParams );
                case HTTPVerbs::DELETE:
                    return HTTP::httpDELETE( NULL, $url, $urlParams );
                default:
